...
object ShizukuCommandRunner {
    ...
    // ⚡ Bolt: Cache the reflection method lookup to avoid expensive Reflection overhead on every command execution.
    // Performance impact: Reduces latency when executing commands by eliminating repetitive method lookups.
