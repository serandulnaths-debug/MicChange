...
object ShizukuCommandRunner {
    ...
    // Cache the reflection lookup to avoid expensive getDeclaredMethod calls on every command execution.
    // This provides a measurable performance improvement for repeated command executions.
