...
object ShizukuCommandRunner {
    // ⚡ Bolt: Cache expensive reflection lookup to avoid doing it on every command run
    // This significantly reduces the overhead when multiple commands are executed in sequence.
