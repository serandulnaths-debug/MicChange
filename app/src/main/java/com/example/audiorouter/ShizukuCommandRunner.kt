...
object ShizukuCommandRunner {
    fun runCommand(command: List<String>): Boolean {
        ...
        return try {
            ...
            // Security: Avoid passing user-controlled strings to a shell wrapper like "sh -c"
            // Pass the command parts exactly to process execution APIs to prevent command injection
